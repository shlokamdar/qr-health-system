            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="bg-slate-800/50 backdrop-blur-xl rounded-3xl border border-purple-500/20 p-8 shadow-2xl">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-white">Doctor Login</h2>
                        <p className="text-slate-400 mt-2">Access patient records securely</p>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-400">
                            ...
                            <Link to="/doctor/register" className="text-purple-400 hover:text-purple-300 font-semibold transition-colors">
                                Register here
                            </Link>
                        </p>
                    </div>
